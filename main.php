        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 text-center" id="header">
                   ...
                   <ul>
                       <li><a href="validate.php">Home</a></li>
                       <li><a href="record.php">All Records</a></li>
                       <li><a href="admin.php">Make Parking Admin</a></li>
                       <li><a style="color: red;" href="logout.php">Logout <?php echo $_SESSION['username']; ?></a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">                                 
                    ...
                    <img src="images/download.jpg" class="car" style="width: 530px; height: 290px; margin-top: 50px; margin-left: 20px;" alt="car picture">
